...
public class Template implements ModuleInterface {
    ...
    public String author() { return "AnTrack Company"; }
    public String desc() { return ""; }
    public String[] startWhen(){ return null; }

    public String command() { return ""; }
    public String result() { return ""; }
    public String resultType() { return ""; }

    public boolean usesRoot() { return false; }
    public boolean usesAdmin() { return false; }
